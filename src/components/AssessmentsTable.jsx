...
export default function Demo() {
  const sampleAssessments = [
    {
      ...
      scoreEntry: {
        score: 85,
        comment:
          "Good work! Strong understanding of core concepts, but could improve on problem-solving strategies.",
    ...
    },
    {
      ...
      scoreEntry: {
        score: 42,
        comment:
          "Excellent presentation skills and creative approach to the problem.",
        gradedAt: "2024-04-02T14:15:00Z",
      },
    },
    {
      $id: "assessment_003",
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <AssessmentsTable assessmentsWithScores={sampleAssessments} />
    </div>
  );
}
